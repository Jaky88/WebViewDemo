package com.jack.demo.webviewdemo.dialog;
...
public class DialogLoading extends Dialog {
    ...
    private TextView mTextViewToastMessage, mTextViewProgressMessage;
    ...
    public DialogLoading(Context context, String msg, boolean enableCancel) {
        ...
        mTextViewToastMessage = (TextView) findViewById(R.id.textView_toast_message);
        mTextViewProgressMessage = (TextView) findViewById(R.id.textView_progress_message);
